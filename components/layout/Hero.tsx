  ...
  return (
    <>
      <section className="relative w-full h-screen mx-auto ">
        <div className="absolute inset-0 top-[120px] mx-auto flex flex-grow items-start gap-5">
          <div
          ...
          <div ref={refHeroDesc}>
            <h1 className="mt-8 text-[30px]">
              Hi, I'm <span className="text-[#915eff]">Huy Nguyen</span>
            </h1>
            <p className="mt-2 text-white-100 text-[20px]">
              ...
              <span
                ...
                style={{}}>
                I wanna be a professinal developer on javascript on bolth client side and nodejs on server side - Short
                term: Imporving all skill at company because i can get more experiences and more busisness, logicals and
                digitals. - Longterm: Can work and build more special and popular applications on web and mobile, maybe
